---
title: "The Finger Multiplication Trick: Multiply 6 to 9 Using Only Your Hands"
...
<!-- ILLUSTRATION: Diagram of two hands with fingers labelled 6-9 from pinky to index finger, thumbs unlabelled -->

### The Three-Step Process

Let's say you want to multiply **7 x 8**.

**Step 1 — Touch the matching fingers together.**
On your left hand, lower your ring finger (7). On your right hand, lower your middle finger (8). Touch those two fingers together.

<!-- ILLUSTRATION: Two hands with the left ring finger and right middle finger touching, remaining fingers clearly visible above and below -->

**Step 2 — Count the tens.**
Count the two touching fingers *plus* every finger below them. These are your tens.
...
**Step 3 — Multiply the remaining fingers.**
Count the fingers *above* the touching point on each hand and multiply them together.
...
<!-- ILLUSTRATION: Two hands showing the 6 x 7 configuration with the pinky-to-ring-finger connection -->
